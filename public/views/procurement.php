    ...
    <?php if (isset($records) && !empty($records)): ?>
        <ul class="list-disc pl-6">
            <?php foreach ($records as $record): ?>
                <li class="mb-2"><?php echo htmlspecialchars($record['item_name']); ?>: <?php echo htmlspecialchars($record['quantity']); ?> at <?php echo money($record['cost']); ?> (Date: <?php echo htmlspecialchars($record['purchase_date']); ?>)</li>
            <?php endforeach; ?>
        </ul>
    <?php else: ?>
